...
class SupportViewEnrollmentsTests(SharedModuleStoreTestCase, SupportViewTestCase):
    ...
    def test_get_enrollments_with_enterprise_filter(self, mock_run_filter):
        ...
        The behavior of the filter's pipeline step (edx-enterprise's
        ...
        def fake_run_filter(enrollments, user):
            for enrollment in enrollments:
                enrollment['enterprise_course_enrollments'] = [mock_enterprise_enrollment]
        ...
        assert call_kwargs['enrollments'][0]['course_id'] == course_id
