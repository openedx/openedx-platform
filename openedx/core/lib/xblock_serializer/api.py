...
def serialize_modulestore_block_for_openedx_core(block):
    """
    This class will serialize an XBlock, producing:
        (1) A new definition ID for use in openedx-core
    ...
    TODO: We should deprecate this in favor of a new openedx-core implementation.
