"""
Tests for static asset files in openedx-core-based Content Libraries
"""
...
class ContentLibrariesStaticAssetsTest(ContentLibrariesRestApiTest):
    ...
    def test_video_transcripts(self):
        """
        Test that video blocks can read transcript files out of openedx-core.
        """
        ...
        # served differently by openedx-core and we should test that too.
