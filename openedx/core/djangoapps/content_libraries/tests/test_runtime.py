"""
Test the openedx-core-based XBlock runtime and content libraries together.
"""
import json
...
class ContentLibraryOlxTests(ContentLibraryContentTestMixin, TestCase):
    """
    Basic test of the openedx-core-based XBlock serialization-deserialization, using XBlocks in a content library.
    """
...
class ContentLibraryRuntimeTests(ContentLibraryContentTestMixin, TestCase):
    """
    Basic tests of the openedx-core-based XBlock runtime using XBlocks in a
    content library.
    """
    ...
    def test_xblock_metadata(self):
        ...
        <problem display_name="New Multi Choice Question" max_attempts="5">
            <multiplechoiceresponse>
                ...
                <label>openedx-core is designed to store.</label>
