...
class ContentLibrariesTestCase(ContentLibrariesRestApiTest):
    """
    General tests for openedx-core-based Content Libraries
    ...
    def test_library_blocks(self):  # pylint: disable=too-many-statements
        ...
        assert 'openedx-core is designed to store.' in fragment['content']
...
class ContentLibraryXBlockValidationTest(APITestCase):
    """Tests only focused on service validation, no openedx-core interactions here."""
