...
Architecture note:
    ...
    and openedx-core. These operations should only be performed within the context of CMS.
    ...
    To ensure that we're not accidentally importing things from openedx-core in the LMS context,
...
def send_events_after_revert(draft_change_log_id: int, library_key_str: str) -> None:
    ...
    try:
        ...
        # When a revert operation is a no-op, openedx-core deletes the empty
