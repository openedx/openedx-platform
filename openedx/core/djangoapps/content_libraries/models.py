...
Content Libraries serves openedx-core-based through LTI 1.3 launches.
...
specific backend (openedx-core).  As such, it decouples from LTI 1.1. and the
...
class ContentLibrary(models.Model):
    ...
    All actual content is stored in openedx-core, and any data that we'd want to
    transfer to another instance if this library were exported and then
    re-imported on another Open edX instance should be kept in openedx-core. This
