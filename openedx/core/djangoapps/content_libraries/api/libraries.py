...
def get_metadata(queryset: QuerySet[ContentLibrary], text_search: str | None = None) -> list[ContentLibraryMetadata]:
    """
    Take a list of ContentLibrary objects and return metadata from openedx-core.
    """
    if text_search:
    ...
    libraries = [
        ...
        ContentLibraryMetadata(
            ...
            # while we shift to openedx-core models.
            num_blocks=0,
            last_published=None,
...
def get_library(library_key: LibraryLocatorV2) -> ContentLibraryMetadata:
    ...
    # with how Blockstore staged changes, but openedx-core works differently,
