...
class VideoConfigService:
    ...
    def upload_transcript(
        ...
        * TranscriptsGenerationException
        ...
        if is_library:
            # Save transcript as static asset in openedx-core if is a library component
...
def _save_transcript_field(video_block):
    """
    Hacky workaround to ensure that transcript field is saved for openedx-core video blocks.
