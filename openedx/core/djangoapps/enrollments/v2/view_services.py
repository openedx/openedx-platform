...
class EnrollmentOperationsService:
    ...
    def create_or_update_enrollment(self, request, has_api_key, course_id):
        ...
        try:
            ...
            # Filter hook that allows plugins to run enrollment-related logic and
            # optionally prevent enrollment via CourseEnrollmentViewStarted.PreventEnrollment.
            try:
                ...
                CourseEnrollmentViewStarted.run_filter(
                    ...
                    requester_is_backend_service=has_api_key,
                )
